...
import { Arrow_Long, Clock, Close, Map_Pin, Plus, Users } from '../assets';
			...
			<div className="flex flex-col gap-3 p-4 rounded-lg bg-zinc-800 w-96">
				...
				<div className="flex items-center gap-3 cursor-pointer text-zinc-500">
					...
					<div className="flex items-center gap-2 text-zinc-400">
						...
						<Arrow_Long className="text-zinc-500" size={16} />
						<p className="text-medium14 text-zinc-400">오전 11:00 - 오후 12:00</p>
					</div>
				</div>
